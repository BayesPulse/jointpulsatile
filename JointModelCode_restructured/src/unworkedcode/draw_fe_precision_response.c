...
void draw_fe_precision_response(Subject_type *sublist, Priors *priors, Common_parms *parms, double v1, double v2, unsigned long *seed)
{
	int *tmp1, j;
